  ...
  return (
    <footer className='flex flex-col gap-4 px-5 pt-10 bg-blue-100'>
      ...
      <div className='border-b-2 border-red-100 px-4 flex justify-between items-center pb-4'>
        <h1 className='text-4xl font-bold text-gray-900 text-center'>Acity Project Portal</h1>
      ...
      <p className='text-sm text-gray-500 text-center'>&copy; 2023 Acity Project Portal. All rights reserved.</p>
    </footer>
  )
}
